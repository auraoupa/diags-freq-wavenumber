...
dsu1=xr.open_mfdataset(dir_data+'*m01*sozocrtx*',combine='by_coords',parallel=True,chunks={'time_counter':1,'x':1000,'y':1000})
dsu2=xr.open_mfdataset(dir_data+'*m02*sozocrtx*',combine='by_coords',parallel=True,chunks={'time_counter':1,'x':1000,'y':1000})
dsu3=xr.open_mfdataset(dir_data+'*m03*sozocrtx*',combine='by_coords',parallel=True,chunks={'time_counter':1,'x':1000,'y':1000})
